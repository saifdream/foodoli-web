...
import {getSpecialList, updateSpecialClick} from "../../store/actions/specials";
...
const useStyles = makeStyles((theme) => ({
    ...
    icon: {
        ...
        //backgroundColor: 'rgb(177,177,177, .2)'
    },
}));
...
const Specials = memo(
    () => {
        ...
        const {specialList, isLoading} = useSelector(state => state.specials);
        ...
        return (
            ...
            >
                ...
                {specialList.map((special, index) => (
                    <React.Fragment key={special?.uid}>
                        {
                            !arr[index] ?
                                        ...
                                        <Paper style={{margin: '3px 3px'}} elevation={0}>
                                            ...
                                            >
                                                <Grid item xs={12} sm={6}>
                                                    ...
                                                    {/*<Typography variant="subtitle2"
                                                                className={classes.price}>$ {special?.price}</Typography>*/}
                                                    <Price price={special?.price} dicount={special?.discount} classname={classes.price} />
                                                    <Divider style={{margin: '20px'}}/>
                                                    <Typography variant="h5">
                                                        {special?.name}
                                                    </Typography>
                    ...
                    /*<GridListTile key={special.image}>
                        <ScrollAnimation animateIn='fadeIn'>
                            <img
                                src={`https://www.newfoodoli.foodoli.com/public/images/specials/${special.image}`}
                                alt={special.title}/>
                        </ScrollAnimation>
                        <GridListTileBar
                            title={special.title}
                            subtitle={<span>by: {special.name}</span>}
                            actionIcon={
